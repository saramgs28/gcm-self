...
public class Usermessaging extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class UserMessagingEndpoint {
    ...
    /**
     * Create a request for the method "userMessagingEndpoint.sendNotification".
     *
     ...
     * @return the request
     */
    public SendNotification sendNotification(com.andresrcb.gcmbackend.usermessaging.model.MessageRecord content) throws java.io.IOException {
      SendNotification result = new SendNotification(content);
      initialize(result);
      return result;
    }

    public class SendNotification extends UsermessagingRequest<Void> {

      private static final String REST_PATH = "sendNotification";
       ...
       * @since 1.13
       */
      protected SendNotification(com.andresrcb.gcmbackend.usermessaging.model.MessageRecord content) {
        super(Usermessaging.this, "POST", REST_PATH, content, Void.class);
      }
