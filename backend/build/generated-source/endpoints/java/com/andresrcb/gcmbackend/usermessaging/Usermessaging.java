...
public class Usermessaging extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class UserMessagingEndpoint {
    ...
    /**
     * Create a request for the method "userMessagingEndpoint.messageNotification".
     *
     * This request holds the parameters needed by the usermessaging server.  After setting any optional
     * parameters, call the {@link MessageNotification#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.andresrcb.gcmbackend.usermessaging.model.MessageRecord}
     * @return the request
     */
    public MessageNotification messageNotification(com.andresrcb.gcmbackend.usermessaging.model.MessageRecord content) throws java.io.IOException {
      MessageNotification result = new MessageNotification(content);
      initialize(result);
      return result;
    }

    public class MessageNotification extends UsermessagingRequest<com.andresrcb.gcmbackend.usermessaging.model.MessageRecord> {
       ...
       * optional parameters, call the {@link MessageNotification#execute()} method to invoke the remote
       * operation. <p> {@link MessageNotification#initialize(com.google.api.client.googleapis.services.
       ...
       * @since 1.13
       */
      protected MessageNotification(com.andresrcb.gcmbackend.usermessaging.model.MessageRecord content) {
        super(Usermessaging.this, "POST", REST_PATH, content, com.andresrcb.gcmbackend.usermessaging.model.MessageRecord.class);
      }

      @Override
      public MessageNotification setAlt(java.lang.String alt) {
        return (MessageNotification) super.setAlt(alt);
      }

      @Override
      public MessageNotification setFields(java.lang.String fields) {
        return (MessageNotification) super.setFields(fields);
      }

      @Override
      public MessageNotification setKey(java.lang.String key) {
        return (MessageNotification) super.setKey(key);
      }

      @Override
      public MessageNotification setOauthToken(java.lang.String oauthToken) {
        return (MessageNotification) super.setOauthToken(oauthToken);
      }

      @Override
      public MessageNotification setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (MessageNotification) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public MessageNotification setQuotaUser(java.lang.String quotaUser) {
        return (MessageNotification) super.setQuotaUser(quotaUser);
      }

      @Override
      public MessageNotification setUserIp(java.lang.String userIp) {
        return (MessageNotification) super.setUserIp(userIp);
      }

      @Override
      public MessageNotification set(String parameterName, Object value) {
        return (MessageNotification) super.set(parameterName, value);
      }
    }
