...
public class Usermessaging extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class UserMessagingEndpoint {
     ...
     * @return the request
     */
    public SendMessage sendMessage(java.lang.String message, java.lang.String token) throws java.io.IOException {
      SendMessage result = new SendMessage(message, token);
      initialize(result);
      return result;
    }
    ...
    public class SendMessage extends UsermessagingRequest<Void> {
       ...
       * @since 1.13
       */
      protected SendMessage(java.lang.String message, java.lang.String token) {
      ...
      public SendMessage setToken(java.lang.String token) {
        this.token = token;
        return this;
      }
